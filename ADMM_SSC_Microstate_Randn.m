...
T= 120;%c*30; %1000; % The Number of data poins a.k.a the number of samples (time points)
...
[missrate,CMat] =SSC(X,r,affine,alpha,outlier,rho,GroundTruthLables);
